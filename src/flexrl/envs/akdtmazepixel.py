'''
Apple-Key-Door-Treasure Maze env with (13, 13, 3) pixel input
'''
...
class AKDTMazePixel(Env):

    def __init__(self):
        super(AKDTMazePixel, self).__init__()
        # Env specs
        ...
        self.observation_shape = (13, 13, 3)
    ...
    def step(self, action):
        ...
        return self.canvas, reward, done, {}  # Info has to be dict
