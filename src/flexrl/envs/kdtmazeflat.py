'''
Key-Door-Treasure Maze env with flattened pixel input (13*13*3)
'''
...
class KDTMazeFlat(Env):

    def __init__(self):
        super(KDTMazeFlat, self).__init__()
        # Env specs
    ...
    def reset(self):
        ...
        return self.canvas.flatten()  # Flatten for MLPs
