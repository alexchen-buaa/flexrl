'''
Apple-Key-Door-Treasure Maze env with agent position coordinates as input
'''
...
class AKDTMaze(Env):
    ...
    def step(self, action):
        ...
        return np.array(self.agent_pos), reward, done, {}  # Info has to be dict
